#' Raphael: very simple model with a deterministic regression learner predicting
#' the mean and then either a separate model predicting sd or having that as a
#' hyperparameter
